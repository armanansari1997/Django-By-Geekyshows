...
def home(request):
    ...
    # student_data = Student.objects.get(name='Arman')  # Not Recommended
    ...
    # student_data = Student.objects.create(name='Sameer', roll=114, city='Bokaro', marks=80, pass_date='2020-5-4')

    # student_data,created = Student.objects.get_or_create(name='Anisa', roll=115, city='Bokaro', marks=80, pass_date='2020-5-4')
    # print(created)
    ...
    #     Student(name='Sahil', roll=117, city='Dhanbad', marks=50, pass_date='2020-5-6'),
    #     Student(name='Kumar', roll=118, city='Dhanbad', marks=40, pass_date='2020-5-9'),
    # ]
    # student_data = Student.objects.bulk_create(objs)

    # all_student_update = Student.objects.all()
    # for stu in all_student_update:
    #     stu.city = 'Dhanbad'
    # student_data = Student.objects.bulk_update(all_student_update, ['city'])
