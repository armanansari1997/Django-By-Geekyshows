...
urlpatterns = [
    ...
    path('geekyshows/', views.RedirectView.as_view(url='https:www.geekyshows.com'), name='geekyshows'),
    path('youtube/', views.GeekyShowsRedirectView.as_view(), name='go-to-youtube'),
