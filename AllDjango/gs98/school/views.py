...
def home(request):
    ...
    # student_data = Student.objects.filter(passdate__range=('2022-04-01', '2022-05-03'))
    # student_data = Student.objects.filter(admdatetime__date=date(2022, 1, 2))
    # student_data = Student.objects.filter(admdatetime__date__gt=date(2022, 1, 4))
    ...
    # student_data = Student.objects.filter(passdate__week_day=1)
